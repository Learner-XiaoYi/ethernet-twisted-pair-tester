...
BSP_GPIO_t oled_scl = {GPIOB, GPIO_PIN_8};
BSP_GPIO_t oled_sda = {GPIOB, GPIO_PIN_9};

extern BSP_GPIO_t oled_scl;
extern BSP_GPIO_t oled_sda;

// 3. 修改宏定义
#define OLED_W_SCL(x)  BSP_GPIO_Write(&oled_scl, (x) ? BSP_GPIO_HIGH : BSP_GPIO_LOW)
#define OLED_W_SDA(x)  BSP_GPIO_Write(&oled_sda, (x) ? BSP_GPIO_HIGH : BSP_GPIO_LOW)
